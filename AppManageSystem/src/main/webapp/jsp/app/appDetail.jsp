            ...
            <%--<form action="${ctx}/app/edit" class="layui-form" method="post">--%>
                ...
                <div class="layui-form-item">
                  ...
                  <%--  <label class="layui-form-label">APP状态</label>
                    <div class="layui-input-inline">
                        <select name="appStatus.valueId" lay-filter="status">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="appInfo" lay-verify="title" autocomplete="off" placeholder="应用简介" class="layui-input" value="${app.appInfo}" >
                    </div>
                    <%--TODO 一级分类--%>
                    <%--TODO  二级分类--%>
                    <%--TODO  三级分类--%>
